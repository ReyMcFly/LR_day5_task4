Action()
{
	...
	web_submit_data("login.pl_2",
		...
		"Mode=HTML",
		ITEMDATA,
		"Name=userSession", "Value={userSession_2}", ENDITEM,
	...
	if ((atoi(lr_eval_string("{FirstClassCount1}")) > atoi(lr_eval_string("{FirstClassCount2}"))) && (atoi(lr_eval_string("{FirstClassCount1}")) > atoi(lr_eval_string("{FirstClassCount2}")))) {
	...
	if ((atoi(lr_eval_string("{FirstClassCount2}")) > atoi(lr_eval_string("{FirstClassCount1}"))) && (atoi(lr_eval_string("{FirstClassCount2}")) > atoi(lr_eval_string("{FirstClassCount3}")))) {	
	
	/* Sign in user12 delete ticket */
